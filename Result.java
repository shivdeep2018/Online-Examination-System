...
public class Result extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtregnum, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String sql="SELECT `subcode` as 'Subject Code', `regnum` as 'Register Number', `totalque` as 'Total Quection', `correctans` as 'Correct Answer', `falseans` as 'False Answer', `avgmark` as 'Average Marks' FROM `mark` WHERE regnum='"+txtregnum.getText()+"' and subcode = '"+txtsubcode.getText()+"'";
